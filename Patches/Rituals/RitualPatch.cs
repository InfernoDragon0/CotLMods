...
namespace CotLMiniMods.Patches.Rituals
{
    ...
    internal class RitualPatch
    {
        ...
        public static void UIRitualsMenuController_OnShowStarted(UIRitualsMenuController __instance)
        {
            ...
            {
                Plugin.Log.LogInfo("Custom Ritual: " + customRitual);
                __instance.ConfigureItem(__instance._ritualItemTemplate.Instantiate<RitualItem>((Transform)__instance._ritualsContent), customRitual);
            }
        }
